                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link href="/courses/cloud-services" className="text-blue-100 hover:text-white transition-colors">
                                    Cloud Services
                                </Link>
                            </li>
                            <li>
                                <Link href="/courses/data-analytics" className="text-blue-100 hover:text-white transition-colors">
                                    Data Analytics
                                </Link>
                            </li>
                            <li>
                                <Link href="/courses/cybersecurity" className="text-blue-100 hover:text-white transition-colors">
                                    Cybersecurity
                                </Link>
                            </li>
                            <li>
                                <Link href="/courses/ai-ml" className="text-blue-100 hover:text-white transition-colors">
                                    AI & ML
                                </Link>
                            </li>
                            <li>
                                <Link href="/courses/custom-software" className="text-blue-100 hover:text-white transition-colors">
                                    Custom Software
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/whitepapers" className="text-blue-100 hover:text-white transition-colors">
                                    Whitepapers
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="/api-docs" className="text-blue-100 hover:text-white transition-colors">
                                    API Documentation
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/security" className="text-blue-100 hover:text-white transition-colors">
                                    Security
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="border-t border-blue-500 pt-8">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-blue-100 text-sm">
                            © 2026 PaniTech Academy. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
